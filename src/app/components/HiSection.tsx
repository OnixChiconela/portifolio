            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
                ...
                <div className="col-span-7 justify-center text-center sm:text-left lg:pr-2">
                    ...
                    <p className="text-lg lg:text-xl mb-4 lg:pr-5">
                        <text className="font-bold">Software developer</text> related to <text className="font-bold">backend development</text> while expading expertise  in
                        <text className="font-bold"> mobile development</text>, seeking to levarege tecnical and softs skills to contribute to a dynamic, forward-thinking organization.
